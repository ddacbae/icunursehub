...
const HEADERS = {
  ...
  'QM체크리스트': [
    ...
    '완료항목', '전체항목', '달성률',
    'VAP-환경위생',
    'UTI-Foley lock확인', 'UTI-소변백위치', 'UTI-소변배액검사',
    'UTI-Foley삽입일모니터링', 'UTI-기저귀확인',
    '안전-수혈감내확인', '안전-수혈라벨확인', '안전-QR코드삭제', '안전-하체피하확인',
    '욕창-침상목욕참여', '욕창-압박예방패드', '욕창-젤패드적용',
    '환경-포켓소독비드', '환경-침대청소', '환경-선반IV폴대',
    '환경-InfusionPump', '환경-N근무환경위생',
    '업무-의사간보고참여', '업무-백라이딩', '업무-간호업무지원',
    '기록-리마인더업데이트', '인계메모'
  ],
  '유치도뇨관': [
